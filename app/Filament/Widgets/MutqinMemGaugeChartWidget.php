...
class MutqinMemGaugeChartWidget extends Widget
{
    ...
    protected function getViewData(): array
    {
        ...
        $defaultMonthlyTarget = (int) settings("mutqin_mem_monthly_target", 40);
        ...
        foreach ($grouped as $recitations) {
            ...
            $studentCumulativePages = $filteredRecitations->sum('mem_pages');
        ...
        return [
            'title' => 'نسبة الإنجاز برنامج المتقن (الحفظ)',
