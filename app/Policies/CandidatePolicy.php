...
class CandidatePolicy
{
    ...
    {
        return $user->hasPermissionTo('accept_candidate') && $candidate->status->value === 'pending';
    }

    public function tointerview(User $user, Candidate $candidate): bool
    {
        return $user->hasPermissionTo('tointerview_candidate') && $candidate->status->value === 'accepted';
    }
}
