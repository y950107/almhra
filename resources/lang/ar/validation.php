...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'quran_level' => 'مستوى الحفظ',
        'has_ijaza' => 'هل لديك إجازة؟',
        'ijaza_types' => 'أنواع الإجازة',
        'ijaza_types.*' => 'نوع الإجازة',
        'desired_recitations' => 'الروايات المطلوبة',
        'desired_recitations.*' => 'الرواية المطلوبة',
        'self_evaluation' => 'التقييم الذاتي',
        'qualification_file' => 'ملف المؤهل العلمي',
        'audio_recitation' => 'ملف التلاوة الصوتية',
        'name'                  => 'الاسم',
